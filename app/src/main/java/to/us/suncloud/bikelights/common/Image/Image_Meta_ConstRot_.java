...
// TODO: BIG: Change the way that Images are interpretted!!  There should be wheel-relative rotation, ground-relative rotation, and the spinner (the idle image can only have wheel-relative motion).  Take care of the GUI and associated Activities and Fragments!
